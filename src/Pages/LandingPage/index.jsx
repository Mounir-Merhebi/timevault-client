...
<div>
      <nav class="lp-nav">
        <div class="lp-container">
            <div class="lp-nav-content">
                ...
                <a onClick={() => {navigate("/Login")}} class="lp-cta-btn">Get Started</a>
            </div>
        </div>
    </nav>
    ...
    <section class="lp-hero">
        <div class="lp-container">
            ...
            <div class="lp-hero-cta">
                <button onClick={() => {navigate("/Login")}} class="lp-cta-primary">Start Your Capsule</button>
    ...
    <section class="lp-cta-section" id="signup">
        <div class="lp-container">
            ...
            <button onClick={() => {navigate("/Login")}} class="lp-cta-primary">Create Your First Capsule</button>
        </div>
    </section>
